import { pgTable, bigserial, varchar, decimal, text, timestamp, jsonb, uniqueIndex, index } from 'drizzle-orm/pg-core';
...
export const approvalExpenseDeptSplit = pgTable('approval_expense_dept_split', {
  ...
  departmentPathIds: jsonb('department_path_ids'),
  departmentPathNames: jsonb('department_path_names'),
