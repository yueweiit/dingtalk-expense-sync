...
export const LINGXIANG_XINGMING_OPERATION_FORM_CODE = 'PROC-E7BC3316-E618-4812-BDCC-7A655A7C694B';
export const LINGXIANG_XINGMING_PURCHASE_FORM_CODE = 'PROC-E69FCD3E-E374-4C54-9D8F-6E1F55AD741F';
export const RETIRED_LINGXIANG_GUANGZHOU_OPERATION_FORM_CODE = 'PROC-14972EC1-2E3B-47DA-8346-9B1DBFE578C5';
export const RETIRED_LINGXIANG_GUANGZHOU_PURCHASE_FORM_CODE = 'PROC-866867B6-1F7B-4F70-AB8F-3500D6560785';
...
export function resolveOperationFormName(processCode: string | null | undefined): string | null {
  ...
  if (value === LINGXIANG_XINGMING_OPERATION_FORM_CODE) return '凌翔星铭运营支出';
  if (value === RETIRED_LINGXIANG_GUANGZHOU_OPERATION_FORM_CODE) return '广州凌翔运营支出';
  return null;
}
...
export function resolvePurchaseFormName(processCode: string | null | undefined): string | null {
  ...
  if (value === LINGXIANG_XINGMING_PURCHASE_FORM_CODE) return '凌翔星铭采购支出';
  if (value === RETIRED_LINGXIANG_GUANGZHOU_PURCHASE_FORM_CODE) return '广州凌翔采购支出';
  return null;
}
