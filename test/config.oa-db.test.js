...
const completeProcessTypeMap = [
  'DINGTALK_PROCESS_TYPE_MAP={"operation":["PROC-0DC5DE17-A29A-497C-8A1F-1324298A04AA","PROC-618F58F6-A68C-4BFE-A92B-49B3CD9B79DD","PROC-39D6CE87-6F84-40B1-A3EB-B96F363CE8F8","PROC-E7BC3316-E618-4812-BDCC-7A655A7C694B","PROC-75FEF975-C79F-44A3-A02C-21734C2DBC49","PROC-CCB314E9-1458-4D53-9EF2-F68A21EA018D","PROC-D3ED660B-A5D4-4516-BC82-D83E52B5FEF8"],"purchase":["PROC-BFDF6F09-4551-43B3-8C55-537AA74A241B","PROC-6E11B527-2F82-439C-817D-C868DE086C97","PROC-481342D0-27B4-461C-A543-4AB0A96D2EDF","PROC-E69FCD3E-E374-4C54-9D8F-6E1F55AD741F","PROC-CA023EF7-CE63-4A0B-B4BB-66482C0E9972","PROC-525D584D-ED10-4B8B-9C7A-9D67257BF6EE","PROC-98934E07-96ED-491C-8650-DFE8C3B707BF"],"monthly_settlement":["PROC-EE85EDD4-5CF2-4C08-B948-1690A6ACC51C"]}',
];
...
test('config loads with OA database credentials and a complete process type map', () => {
  ...
  assert.equal(parsed.allProcessCodes.length, 15);
